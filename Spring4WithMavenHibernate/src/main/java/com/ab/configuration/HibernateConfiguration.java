...
@ComponentScan({ "com.ab.configuration" })
...
public class HibernateConfiguration {
	...
	/*
	 * @Bean public HibernateTemplate getHibernateTemplate() { HibernateTemplate hb
	 * = new HibernateTemplate(); hb.setSessionFactory((SessionFactory)
	 * sessionFactory()); return hb; }
	 */
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "com.ab.model" });
